  ...
  <body>
      ...
      <div class="write-container">
        ...
        <form id="writeForm" class="write-form" method="post" action="/admin/board/edit.do" enctype="multipart/form-data">
          ...
          <div class="form-group">
              ...
              <input type="text" name="boardTitle" id="title" class="form-input" value="${post.boardTitle}" required>
          </div>

          <div class="form-group">
              <label class="form-label required">내용</label>
              <textarea name="boardContent" id="content" class="form-textarea" required>${post.boardContent}</textarea>
          </div>
          ...
          <div class="form-actions">
              <button type="button" class="btn btn-cancel" onclick="loadPage('/admin/board/detail?boardNo=${post.boardNo}')">취소</button>
	...
	document.getElementById("writeForm").addEventListener("submit", function(e) {
		     ...
		     .then(html => {
		         ...
		         loadPage("/admin/boardManagement");
		     })
		     .catch(err => {
		         alert("수정 중 오류 발생!");
		     });
		 ...
		 function initNoticeWrite() {
		   ...
		   form.addEventListener("submit", function(e) {
		     ...
		     fetch(form.action, { method: "POST", body: formData })
		       .then(() => loadPage("/admin/boardManagement"))
		       .catch(() => alert("등록 실패"));
		   });
		 }
